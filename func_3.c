...
/**
 * print_pointer - a fun that prints the value of a pointer variable
...
/**
 * print_non_printable - a fun that prints ascii codes in hexa
...
/**
 * print_reverse - a fun that prints reverse string
 * @types: a list of arguments
 * @buffer: it buffer array to handle print
 * @flags:  it calculates active flags
 * @width: getting width
...
/**
 * print_rot13string - a fun that print a string in rot13
 * @types: a list of arguments
 * @buffer: it buffer array to handle print
 * @flags:  it calculates active flags
 * @width: getting width
